...
// não fiz nenhuma alteração, usei o mesmo código que estava no github

public class Main {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        SistemaReservas sistema = new SistemaReservas(); //instância da classe que controla o sistema
        int opcao;
